...
public class F01_LinkedList {
    ...
    public void addMiddle(int index, int data) {
         ...
         * need to change our head so we will call add first function
         */
    ...
    public void reverse() {
        ...
        while (curr != null) {
            next = curr.next;
            curr.next = prev;     // pointing or adress chaning step
            prev = curr;
            curr = next;
    ...
    public static void main(String args[]) {
        ...
        F01_LinkedList ll = new F01_LinkedList();
